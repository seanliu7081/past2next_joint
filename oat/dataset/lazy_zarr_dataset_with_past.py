...
from oat.dataset.lazy_zarr_dataset import LazyZarrDataset, is_numeric_dtype


class LazyZarrDatasetWithPastAction(LazyZarrDataset):
    """
    Extends LazyZarrDataset to also return `past_action` — the past_n action
